...
<html>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="animenews.php">Anime News</a>
                        </li>
                        <li class="nav-item">
  ...
  <a href="#" class="list-group-item list-group-item-action list-group-item-light">Tokyo Ghouls</a>
  <a href="#" class="list-group-item list-group-item-action list-group-item-dark">Naruto</a>
</div>